...
export default function GreyBanner() {
  ...
  const buttonClasses = [
    ...
    "transition-all duration-300 border-b-2 border-[#0070C0]",
    "bg-[#001F5B] text-white shadow-md scale-110 shadow-[#72A9BE]",
    "hover:border-blue-100",
  ].join(" ");

  return (
    <div className="relative w-full min-h-[20px] flex items-center justify-center px-7 py-1 overflow-hidden">
      <div className="absolute inset-0 animate-marble bg-[#72A9BE] opacity-60 blur-sm"></div>
